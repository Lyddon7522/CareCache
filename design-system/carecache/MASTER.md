...
|------|-----|--------------|
| Primary | `#4A4FC4` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#C64B64` | `--color-secondary` |
| Accent/CTA | `#4A4FC4` | `--color-accent` |
| Background | `#F8F8FD` | `--color-background` |
| Foreground | `#22243A` | `--color-foreground` |
| Muted | `#ECECF4` | `--color-muted` |
| Border | `#DFE0EC` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#4A4FC4` | `--color-ring` |

**Color Notes:** Calm dusk indigo + warm coral; intentionally distinct from Creaturely's greens
